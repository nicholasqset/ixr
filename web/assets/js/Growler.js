...
Growler = Class.create({
	...
	warn: function(msg, options){
		return this.specialNotice( msg, options, "Warning!", "#F6BD6F", "#000");
	},
	error: function(msg, options){
		return this.specialNotice( msg, options, "Critical!", "#F66F82", "#000");
	},
	info: function(msg, options){
		return this.specialNotice( msg, options, "Information!", "#BBF66F", "#000");
	},
