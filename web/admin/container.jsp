...
<html>
    <head>
        ...
        <title>iXR&trade; 1.1 - <%= company.companyName %></title>
...
<!--                            <div class="menu-header-right"><%= gui.formHref("onclick = \"container.reloadMenu();\"", request.getContextPath(), "reload.png", "", "Reload Menu", "", "") %></div>
  ...
  <ul class="navbar-nav">
    <li class="nav-item">
        <a class="nav-link" href="admin/companies"  target="content-iframe"><%=gui.formIcon(request.getContextPath(), "user-identity.png", "", "") %> Companies</a>
    </li>
    <li class="nav-item">
      <a class="nav-link" href="admin/subscriptions"  target="content-iframe"><%=gui.formIcon(request.getContextPath(), "user-identity.png", "", "") %>Subscriptions</a>
    </li>
    <li class="nav-item">
     <a href = "./admin/subscriptions" target="content-iframe"><%=gui.formIcon(request.getContextPath(), "user-identity.png", "", "") %> Registrations</a>
    </li>
  </ul>
