    ...
    final class OutPatients {
        ...
        public String getGrid() {
            ...
            if (recordCount > 0) {
                ...
                filterSql = filterSql.equals("") ? " WHERE  sp_code IN (select sp_code from " + this.comCode + ".hmstaffspexs where staffno = '"+this.userId+"') " : 
                " AND  sp_code IN (select sp_code from " + this.comCode + ".hmstaffspexs where staffno = '"+this.userId+"') ";
...
//            html += "initTabs(\'dhtmlgoodies_tabView1\', Array(\'Profile\', \'History\', \'Vital Parameter\', \'Complaints\', \'Laboratory\', \'Diagnosis\', \'Medication\', \'Doctor Notes\',\'Discharge\'), 0, 625, 365, Array(false));";
            html += "initTabs(\'dhtmlgoodies_tabView1\', Array(\'Profile\', \'History\', \'Vital Parameter\', \'Complaints\', \'Laboratory\', \'Diagnosis\', \'Doctor Notes\', \'Billing\', \'Prescription\',\'Discharge\'), 0, 650, 365, Array(false));";
            html += "</script>";
