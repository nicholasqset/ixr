...
//        this.regType = sys.getRecordCount("VIEWHMREGISTRATION", "PTNO = '"+ this.ptNo+ "'") > 0? "R": "N";
	...
	html += "<td>"+gui.formAutoComplete("ptNo", 15, this.id != null? this.ptNo: "", "registration.searchPatient", "ptNoHd", this.id != null? this.ptNo: "")+"</td>";
	html += "</tr>";
	...
	html += "<td>"+gui.formAutoComplete("drNo", 15, this.id != null? this.drNo: "", "registration.searchDoctor", "drNoHd", this.id != null? this.drNo: "")+" <span id = \"spDoctor\">"+drName+"</span></td>";
	html += "</tr>";
        
        html += "<tr>";
	html += "<td>"+gui.formIcon(request.getContextPath(),"doctor-female.png", "", "")+" "+gui.formLabel("nrNo", "Nurse")+"</td>";
	html += "<td>"+gui.formAutoComplete("nrNo", 15, this.id != null? this.nrNo: "", "registration.searchNurse", "nrNoHd", this.id != null? this.nrNo: "")+" <span id = \"spNurse\">"+nrName+"</span></td>";
	html += "</tr>";
    ...
    public String searchPatient(){
        ...
        Gui gui = new Gui();
        html += gui.getAutoColsSearch(this.comCode+".HMPTPROFILE", "PTNO, FULLNAME", "", this.ptNo);
    ...
    public String searchDoctor(){
        ...
        Gui gui = new Gui();
        html += gui.getAutoColsSearch(this.comCode+".VIEWHMDOCTORS", "STAFFNO, FULLNAME", "", this.drNo);
    ...
    public String searchNurse(){
        ...
        Gui gui = new Gui();
        html += gui.getAutoColsSearch(this.comCode+".VIEWHMNURSES", "STAFFNO, FULLNAME", "", this.nrNo);
...
//                        + "'"+sys.getLogDate()+"', "
    ...
    public String listBills(){
        ...
        html += "<div style = \"padding: 7px 0;\">"+ gui.formButton(request.getContextPath(), "button", "btnAdd", "Add", "math-add.png", "onclick = \"registration.manageBill(); return false;\"", "")+ "</div>";
