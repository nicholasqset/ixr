    ...
    <body>
        ...
        <script type="text/javascript">
            ...
            var receipt = {
                ...
                getInvDtls : function(regNo, invNo){
                    module.execute('getInvDtls', "regNo="+ regNo +"&invNo="+ invNo, 'divReceipts');
                },
                editReceipt : function(regNo, invNo, amount){
                    module.execute('editReceipt', "regNo="+ regNo +"&invNo="+ invNo + "&amount="+ amount, 'divReceipts');
                },
			...
			new Ajax.Request(module.ajaxUrl ,{
                ...
                getReceipts: function(regNo){
                    module.execute('getReceipts', "regNo="+regNo, 'divReceipts');
                },
                printReceipt: function(receiptNo){
                    var printWindow = window.open('./print?receiptNo='+receiptNo,'name','height=450,width=800,toolbar=no,menubar=no,directories=no,location=no,scrollbars=yes,status=no,resizable=no,fullscreen=no,top=200,left=200');
                    printWindow.focus();
                }
