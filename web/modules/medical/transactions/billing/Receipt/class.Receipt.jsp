...
<%@page import="com.qset.medical.MedicalItem"%>
...
//	html += "</tr>";
            html += gui.formInput("hidden", "billNo", 15, this.bid != null ? this.pyNo : "", "", "disabled");
            html += gui.formInput("hidden", "billNoHd", 15, this.bid != null ? this.pyNo : "", "", "");
            html += gui.formInput("hidden", "entryDate", 15, this.bid != null ? this.entryDate : defaultDate, "", "");
...
//        html += "</tr>";
            html += gui.formInput("hidden", "pyDesc", 30, this.bid != null ? this.pyDesc : this.ptNo + "-" + patientProfile.fullName, "", "");
...
//	html += "</tr>";
            ...
            html += "<td width = \"35%\" nowrap>" + gui.formAutoComplete("itemNo", 13, "", "receipt.searchItem", "itemNoHd", "") + "</td>";
...
//        html += gui.getAutoColsSearch("VIEWHMITEMS", "ITEMCODE, ITEMNAME", "", this.itemCode);
        ...
        public String getPaymentUi() {
            ...
            String amount_ = system.getOneAgt("" + this.comCode + ".VIEWHMPYDTLS", "SUM", "AMOUNT", "SM", "PYNO = '" + this.pyNo + "'");
...
//            html += "</tr>";
            ...
            html += "<td nowrap>" + gui.formInput("text", "tenderCash", 15, "", "onkeyup = receipt.getChange();", "") + "</td>";
            html += "</tr>";

            html += "<tr>";
            html += "<td nowrap>" + gui.formIcon(request.getContextPath(), "phone.png", "", "") + gui.formLabel("tenderMpesa", " Mpesa") + "</td>";
            html += "<td nowrap>" + gui.formInput("text", "tenderMpesa", 15, "", "onkeyup = receipt.getChange();", "") + "</td>";
            html += "</tr>";

            html += "<tr>";
            html += "<td nowrap>" + gui.formIcon(request.getContextPath(), "house.png", "", "") + gui.formLabel("tenderBank", " Other") + "</td>";
            html += "<td nowrap>" + gui.formInput("text", "tenderBank", 15, "", "onkeyup = receipt.getChange();", "") + "</td>";
            html += "</tr>";
        ...
        public Object savePayment() throws Exception {
            ...
            this.pyNo = request.getParameter("receiptNoHd");
            ...
            try {
                ...
                if (this.change >= 0) {
                    ...
                    if (saved > 0) {
                        ...
                        obj.put("success", new Integer(0));
                        obj.put("message", "An error occured while updating record." + query);
                    }
                } else {
                    obj.put("success", new Integer(0));
