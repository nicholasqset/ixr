            ...
            var receipt = {
                searchPatient: function(){
                    ...
                    if(count <= 0){
                        ...
                        new Ajax.Autocompleter(
                                ...
                                minChars   : 2,
                                frequency  : 1.0,
                                afterUpdateElement : receipt.setPatient
                            });
                    }
                },
                setPatient: function(text, staff){
                    if(staff.id !== ''){
                        ...
                        receipt.getPatientProfile(staff.id);
//                        receipt.getRegItems();
                    }
                },
                ...
                searchDoctor: function(){
                    ...
                    if(count <= 0){
                        ...
                        new Ajax.Autocompleter(
                                ...
                                minChars   : 2,
                                frequency  : 1.0,
                                afterUpdateElement : receipt.setDoctor
                            });
                    }
                },
                setDoctor: function(text, doctor){
                    if(doctor.id !== ''){
                        ...
                        receipt.getDoctorProfile(doctor.id);
                    }
                },
                ...
                searchNurse: function(){
                    ...
                    if(count <= 0){
                        ...
                        new Ajax.Autocompleter(
                                ...
                                minChars   : 2,
                                frequency  : 1.0,
                                afterUpdateElement : receipt.setNurse
                            });
                    }
                },
                setNurse: function(text, nurse){
                    if(nurse.id !== ''){
                        ...
                        receipt.getNurseProfile(nurse.id);
                    }
                },
			...
			new Ajax.Request(module.ajaxUrl ,{
                ...
                getPaymentUi: function(billNo){
                    var params = 'function=getPaymentUi&billNoHd='+ billNo;
                    TINY.box.show({url: module.ajaxUrl, post: params, width: 320, height: 208});
                },
                getChange: function(){
