...
//            html += "<br>";
        ...
        public String getPyDtls() {
            ...
            if (sys.recordExists(this.comCode + ".VIEWHMPHARMDTLS", "")) {
...
//                    }
                    if(pmcode.equals("all")){
                        query   = " SELECT * FROM "+comCode+".VIEWHMPHARMDTLS WHERE ENTRYDATE::DATE BETWEEN '"+ entryDateLbl1+ "' AND '"+ entryDateLbl2+ "'  AND CHANGE >= 0";
                    }else{
                        query   = " SELECT * FROM "+comCode+".VIEWHMPHARMDTLS WHERE ENTRYDATE::DATE BETWEEN '"+ entryDateLbl1+ "' AND '"+ entryDateLbl2+ "'  AND CHANGE >= 0 AND PMCODE = '"+pmcode+"'";
                    }
