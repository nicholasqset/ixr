    ...
    <body>
        ...
        <script type="text/javascript">
            ...
            var inventory = {
                ...
                toggleTransId: function(){
                    if($('autoTransId').checked === true){
                        if($('transId')) $('transId').disabled = true;
                    }else{
                        if($('transId')) $('transId').disabled = false;
                    }
                },
			...
			new Ajax.Request(module.ajaxUrl ,{
                            ...
                            onSuccess: function(request) {
                                ...
                                if(typeof response.success==='number' && response.success===1){
                                    if(typeof response.transId !== 'undefined' && response.transId !== '' && $('autoTransId').checked === true){
                                        if($('transId')) $('transId').value = response.transId;
                                    }
