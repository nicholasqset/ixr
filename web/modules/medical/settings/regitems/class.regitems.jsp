...
final class RegItems{
    String table        = "HMREGITEMS";
    String view         = "VIEWHMREGITEMS";
    ...
    public String getGrid(){
        ...
        gridSql = "SELECT * FROM "+this.view+" "+filterSql+" ORDER BY PYEAR DESC, PMONTH DESC, REGTYPE, ITEMCODE LIMIT "
        ...
        try{
            ...
            while(rs.next()){
                ...
                String amontLbl = amount == null? "Not Set": amount;
	...
	html += "<td>"+gui.formIcon(request.getContextPath(),"page-edit.png", "", "")+" "+gui.formLabel("itemCode", "Item")+"</td>";
        html += "<td>"+gui.formSelect("itemCode", "HMITEMS", "ITEMCODE", "ITEMNAME", "", "ISDRUG IS NULL", this.id != null? this.itemCode: "", "", false)+"</td>";
	html += "</tr>";
        
        HashMap<String, String> regTypes = new HashMap<String, String>();
	...
	html += "<td>"+gui.formIcon(request.getContextPath(),"page-white-edit.png", "", "")+" "+gui.formLabel("regType", "Registration Type")+"</td>";
        html += "<td>"+gui.formArraySelect("regType", 150,  new  HashMap<String, String>(regTypes), this.regType, false, "", true)+"</td>";
	html += "</tr>";
        
        html += "<tr>";
	html += "<td>&nbsp;</td>";
	html += "<td>";
	html += gui.formButton(request.getContextPath(), "button", "btnSave", "Save", "save.png", "onclick = \"regItems.save('pYear pMonth itemCode regType');\"", "");
        if(this.id != null){
            html += gui.formButton(request.getContextPath(), "button", "btnDelete", "Delete", "delete.png", "onclick = \"regItems.purge("+this.id+",'"+this.itemCode+"');\"", "");
        }
