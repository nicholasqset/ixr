    ...
    <body>
        ...
        <script type="text/javascript">
            ...
            var vendors = {
                ...
                toggleVendId: function(){
                    if($('autoVendId').checked === true){
                        if($('vendId')) $('vendId').disabled = true;
                    }else{
                        if($('vendId')) $('vendId').disabled = false;
                    }
                },
			...
			new Ajax.Request(module.ajaxUrl ,{
                            ...
                            onSuccess: function(request) {
                                ...
                                if(typeof response.success==='number' && response.success===1){
                                    if(typeof response.vendId !== 'undefined' && response.vendId !== '' && $('autoVendId').checked === true){
                                        if(typeof response.vendId !== 'undefined' && $('vendId')) $('vendId').value = response.code;
                                    }
