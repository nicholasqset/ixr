...
<%
    final class PrintRptStmt{
        ...
        String supplierNo   = request.getParameter("supplierNo") != null && ! request.getParameter("supplierNo").trim().equals("")? request.getParameter("supplierNo"): null;
    
        String rptName      = "Supplier Statement";
        ...
        public String getReportDetails(){
            ...
            html += "<tr>";
            html += "<td width = \"17%\" class = \"bold\">Supplier No</td>";
            html += "<td>"+ this.supplierNo +"</td>";
            html += "</tr>";

            html += "<tr>";
            html += "<td class = \"bold\">Description</td>";
            html += "<td>"+ aPSupplierProfile.supplierName+ "</td>";
            html += "</tr>";
        ...
        public String getStmtDtls(){
            ...
            if(sys.recordExists(comCode+".VIEWAPOB", "SUPPLIERNO = '"+ this.supplierNo+ "'")){
               ...
               html += "<tr>";
                ...
                try{
                    ...
                    query = "SELECT * FROM "+comCode+".VIEWAPOB WHERE SUPPLIERNO = '"+ this.supplierNo+ "' ORDER BY DOCDATE";
