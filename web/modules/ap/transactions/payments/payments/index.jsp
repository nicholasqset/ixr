            ...
            var payments = {
                    ...
                    if(count <= 0){
                        ...
                        new Ajax.Autocompleter(
                                'batchNo', getResultTo, module.ajaxUrl, {
                                    ...
                                    minChars   : 2,
                                    frequency  : 1.0,
                                    afterUpdateElement : payments.setBatch
                                }
                            );
                    }
                },
                setBatch: function(text, batch){
                    if(batch.id !== ''){
                        ...
                        payments.getBatchProfile(batch.id);
                    }
                },
                ...
                searchSupplier: function(){
                    ...
                    if(count <= 0){
                        ...
                        new Ajax.Autocompleter(
                                ...
                                minChars   : 2,
                                frequency  : 1.0,
                                afterUpdateElement : payments.setSupplier
                            });
                    }
                },
                setSupplier: function(text, supplier){
                    if(supplier.id !== ''){
                        ...
                        payments.getSupplierProfile(supplier.id);
                        /*
                         * payments.getPyEntries();
                         */
                    }
                },
                    ...
                    new Ajax.Request(module.ajaxUrl, {
                        ...
                        onSuccess: function(request) {
                            ...
                            if(typeof response.success === 'number' && response.success === 1){
                                ...
                                if(typeof response.bankBranch !== 'undefined' && $('bankBranch')) $('bankBranch').value = response.bankBranch;
                                if(typeof response.payMode !== 'undefined' && $('payMode')) $('payMode').value = response.payMode;
			...
			new Ajax.Request(module.ajaxUrl, {
                            ...
                            onSuccess: function(request) {
                                ...
                                if(typeof response.success==='number' && response.success===1){
                                    ...
                                    if(typeof response.paymentNo !== 'undefined'){
                                        if($('paymentNo')) $('paymentNo').value = response.paymentNo;
                                        if($('paymentNoHd')) $('paymentNoHd').value = response.paymentNo;
                                    }
                                    
                                    if($('dvPyEntries')) payments.getPyEntries();
                 ...
                 editPaymentDtls: function(sid){
                    new Ajax.Request(module.ajaxUrl, {
                        method:'post',
                        parameters: 'function=editPaymentDtls&sid='+ sid,
                        requestHeaders: { Accept: 'application/json'},
                        onSuccess: function(request) {
                            response = request.responseText.evalJSON();
                            if(typeof response.success === 'number' && response.success===1){
                ...
                print: function(required){
                    if(module.validate(required)){
                        ...
                        var paymentNo = $('paymentNo')? $F('paymentNo'): '';
                        var printWindow = window.open(
                                './print?batchNo='+ batchNo+ '&paymentNo='+ paymentNo, '', 'height=450, width=800, toolbar=no, menubar=no, directories=no, location=no, scrollbars=yes, status=no, resizable=no, fullscreen=no, top=200, left=200');
                        printWindow.focus();
                    }
                }
            };
