...
final class Batch{
    ...
    String table            = comCode+".APPYBATCHES";
...
//                    
//                    String batchTotalStr = sys.getOne("APPYDTLS", "SUM(APLAMOUNT)", "BATCHNO = '"+ batchNo+ "'");
...
//                    }
                    ...
                    html += "<td>"+ rtpUi+ "</td>";
                    html += "<td>"+ postedUi+ "</td>";
                    html += "<td>"+ sys.numberFormat(accountsPayable.getPyBatchAmount(batchNo).toString())+ "</td>";
                    html += "<td>"+ edit+ "</td>";
                    html += "</tr>";
    ...
    public Object rtp() throws Exception{
        ...
        try{
            ...
            if(accountsPayable.getPyBatchAmount(this.batchNo) == 0){
                rts = 0;
    ...
    public Object post() throws Exception{
         ...
         try{
            ...
            Integer batchPosted = accountsPayable.postPyBatch(this.batchNo, session, request);
