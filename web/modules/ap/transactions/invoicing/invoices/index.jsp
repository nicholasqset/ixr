            ...
            var invoices = {
                ...
                searchSupplier: function(){
                    ...
                    if(count <= 0){
                        ...
                        new Ajax.Autocompleter(
                                ...
                                minChars   : 2,
                                frequency  : 1.0,
                                afterUpdateElement : invoices.setSupplier
                            });
                    }
                },
                setSupplier: function(text, supplier){
                    if(supplier.id !== ''){
                        ...
                        invoices.getSupplierProfile(supplier.id);
                        /*
                    ...
                    new Ajax.Request(module.ajaxUrl ,{
                            ...
                            onSuccess: function(request) {
                                ...
                                if(typeof response.success === 'number' && response.success === 1){
                                    ...
                                    if(typeof response.distribution !== 'undefined' && $('distribution')) $('distribution').value = response.distribution;
