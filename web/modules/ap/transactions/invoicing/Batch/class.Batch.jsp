...
<%@page import="com.qset.ap.AccountsPayable"%>
...
final class Batch{
    ...
    String table            = comCode+".APINBATCHES";
...
//                            postedUi = "Open";
                    ...
                    html += "<td>"+ rtpUi+ "</td>";
                    html += "<td>"+ postedUi+ "</td>";
                    html += "<td>"+ sys.numberFormat(accountsPayable.getInBatchAmount(batchNo).toString())+ "</td>";
                    html += "<td>"+ edit+ "</td>";
                    html += "</tr>";
    ...
    public Object rtp() throws Exception{
         ...
         try{
            ...
            if(accountsPayable.getInBatchAmount(this.batchNo) == 0){
                rts = 0;
    ...
    public Object post() throws Exception{
         ...
         try{
            ...
            Integer batchPosted = accountsPayable.postInBatch(this.batchNo, session, request);
