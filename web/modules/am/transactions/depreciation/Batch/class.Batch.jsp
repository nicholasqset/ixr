...
final class Batch{
    HttpSession session     = request.getSession();
        ...
        String table            = comCode+".AMDPBATCHES";
...
//                    
                    String batchTotal_ = sys.getOneAgt("AMDPDTLS", "SUM", "DEPV", "SM", "BATCHNO = '"+ batchNo+ "'");
                    if(batchTotal_ != null){
    ...
    public JSONObject post() throws Exception{
         ...
         try{
            ...
            String batchPosted = aM.postDpBatch(this.batchNo, session, request);
