...
final class Batch{
    HttpSession session     = request.getSession();
        ...
        String table            = comCode+".AMAQBATCHES";
...
//                    
                    String batchTotal_ = sys.getOneAgt("AMAQDTLS", "SUM", "OPC", "SM", "BATCHNO = '"+ batchNo+ "'");
                    if(batchTotal_ != null){
    ...
    public JSONObject post() throws Exception{
         ...
         try{
            ...
            String batchPosted = aM.postAqBatch(this.batchNo, session, request);
