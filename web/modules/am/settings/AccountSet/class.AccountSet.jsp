...
final class AccountSet{
    ...
    String accSetName   = request.getParameter("name");
    String astCtlAcc    = request.getParameter("astCtlAcc");
    String acmDepAcc    = request.getParameter("acmDepAcc");
    String depExpAcc    = request.getParameter("depExpAcc");
    String depAdjAcc    = request.getParameter("depAdjAcc");
    String diCostAcc    = request.getParameter("diCostAcc");
    String diPrcdAcc    = request.getParameter("diPrcdAcc");
        ...
        if(recordCount > 0){
            ...
            try{
                ...
                while(rs.next()){
                    ...
                    String accSetName    = rs.getString("ACCSETNAME");
                    ...
                    html += "<td>"+ count+ "</td>";
                    html += "<td>"+ accSetCode+ "</td>";
                    html += "<td>"+ accSetName+ "</td>";
                    html += "<td>"+ edit+ "</td>";
                    html += "</tr>";
    ...
    public String getModule(){
        ...
        if(this.id != null){
            try{
                ...
                while(rs.next()){
                    ...
                    this.astCtlAcc      = rs.getString("ASTCTLACC");		
                    this.acmDepAcc      = rs.getString("ACMDEPACC");		
                    this.depExpAcc      = rs.getString("DEPEXPACC");		
                    this.depAdjAcc      = rs.getString("DEPADJACC");		
                    this.diCostAcc      = rs.getString("DICOSTACC");		
                    this.diPrcdAcc      = rs.getString("DIPRCDACC");		
                }
            }catch (SQLException e){
                html += e.getMessage();
            }catch(Exception e){
        ...
        html += "<tr>";
	html += "<td width = \"15%\">"+ gui.formIcon(request.getContextPath(),"page.png", "", "")+ gui.formLabel("code", " Account Set Code")+ "</td>";
	html += "<td>"+gui.formInput("text", "code", 10, this.id != null? this.accSetCode: "" , "", "")+"</td>";
	html += "</tr>";
        
        html += "<tr>";
	html += "<td>"+gui.formIcon(request.getContextPath(),"page-edit.png", "", "")+ gui.formLabel("name", " Account Set Name")+"</td>";
	html += "<td>"+gui.formInput("text", "name", 35, this.id != null? this.accSetName: "", "", "")+"</td>";
	html += "</tr>";
	...
	html += "<td>&nbsp;</td>";
	html += "<td>";
	html += gui.formButton(request.getContextPath(), "button", "btnSave", "Save", "save.png", "onclick = \"accountSet.save('code name astCtlAcc acmDepAcc depExpAcc depAdjAcc diCostAcc diPrcdAcc');\"", "");
        if(this.id != null){
            html += gui.formButton(request.getContextPath(), "button", "btnDelete", "Delete", "delete.png", "onclick = \"accountSet.purge("+this.id+",'"+this.accSetName+"');\"", "");
        }
        ...
        try{
            ...
            if(this.id == null){
                ...
                query = "UPDATE "+ this.table+ " SET "
                        ...
                        + "ACCSETNAME   = '"+ this.accSetName+ "',"
                        + "ASTCTLACC    = '"+ this.astCtlAcc+ "',"
                        + "ACMDEPACC    = '"+ this.acmDepAcc+ "',"
                        + "DEPEXPACC    = '"+ this.depExpAcc+ "',"
                        + "DEPADJACC    = '"+ this.depAdjAcc+ "',"
                        + "DICOSTACC    = '"+ this.diCostAcc+ "',"
                        + "DIPRCDACC    = '"+ this.diPrcdAcc+ "'"
                        + "WHERE ID     = "+ this.id;
            }
