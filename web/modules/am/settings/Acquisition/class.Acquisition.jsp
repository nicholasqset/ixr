...
final class Acquisition{
    ...
    String aqName       = request.getParameter("name");
        ...
        if(recordCount > 0){
            ...
            try{
                ...
                while(rs.next()){
                    ...
                    String aqName   = rs.getString("AQNAME");
    ...
    public String getModule(){
        ...
        if(this.id != null){
            ...
            try{
                ...
                while(rs.next()){
                    this.aqCode        = rs.getString("AQCODE");		
                    this.aqName        = rs.getString("AQNAME");		
        ...
        html += "<tr>";
	html += "<td width = \"15%\">"+ gui.formIcon(request.getContextPath(),"page.png", "", "")+ gui.formLabel("code", " Acquisition Code")+ "</td>";
	html += "<td>"+gui.formInput("text", "code", 10, this.id != null? this.aqCode: "" , "", "")+"</td>";
	html += "</tr>";
        
        html += "<tr>";
	html += "<td>"+gui.formIcon(request.getContextPath(),"page-edit.png", "", "")+ gui.formLabel("name", " Acquisition Name")+"</td>";
	html += "<td>"+gui.formInput("text", "name", 35, this.id != null? this.aqName: "", "", "")+"</td>";
	html += "</tr>";
	...
	html += "<td>&nbsp;</td>";
	html += "<td>";
	html += gui.formButton(request.getContextPath(), "button", "btnSave", "Save", "save.png", "onclick = \"acquisition.save('code name distribution');\"", "");
        if(this.id != null){
            html += gui.formButton(request.getContextPath(), "button", "btnDelete", "Delete", "delete.png", "onclick = \"acquisition.purge("+this.id+",'"+this.aqName+"');\"", "");
        }
