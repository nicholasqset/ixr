...
<%
    ...
    final class Schedule {
        ...
        public String getModule() {
            ...
            html += "<td>" + gui.formSelect("pYear", this.comCode+".FNFISCALPRD", "PYEAR", "", "PYEAR DESC", this.id != null ? "PYEAR = " + this.pYear : "PYEAR = " + sys.getPeriodYear(this.comCode), this.id != null ? "" + this.pYear : "" + sys.getPeriodYear(this.comCode), "", false) + "</td>";
            html += "</tr>";

            html += "<tr>";
            html += "<td nowrap>" + gui.formIcon(request.getContextPath(), "view-pim-calendar.png", "", "") + gui.formLabel("leaveType", " Leave Type") + "</td>";
            html += "<td>" + gui.formSelect("leaveType", this.comCode+".HRLVTYPES", "LVTYPECODE", "LVTYPENAME", null, "LVTYPE = 'AN'", this.id != null ? this.lvTypeCode : "", "onchange = \"schedule.getEntitlement();\"", false) + "</td>";
            html += "</tr>";
