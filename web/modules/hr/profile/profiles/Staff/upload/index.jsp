...
//        out.println(filePath + fileName);
        ...
        query = "DELETE FROM "+comCode+".HRSTAFFPHOTOS WHERE PFNO = '"+ pfNo+ "'";
        stmt.executeUpdate(query);
        
        PreparedStatement ps;
        
        Integer id = sys.generateId(comCode+".HRSTAFFPHOTOS", "ID");
        
//        query = "INSERT INTO HRSTAFFPHOTOS "
//                    + "(ID, PFNO, PHOTO, FILENAME, FILETYPE, FILESIZE) "
//                    + " VALUES (?, ?, ?, ?, ?, ?)";
        
        query = "INSERT INTO "+comCode+".HRSTAFFPHOTOS "
                    + "(ID, PFNO, PHOTO, FILENAME, FILETYPE, FILESIZE, AUDITUSER) "
                    + " VALUES (?, ?, ?, ?, ?, ?, ?)";
