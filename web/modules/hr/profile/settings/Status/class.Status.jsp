...
final class Status{
    ...
    String table        = session.getAttribute("comCode")+".HRSTATUS";
...
//            System.out.println("gridSql=="+ gridSql);
            ...
            try{
                ...
                while(rs.next()){
                    ...
                    String active_ = active == 1? gui.formIcon(request.getContextPath(),"tick.png", "", ""): gui.formIcon(request.getContextPath(),"cross.png", "", "");
	...
	html += "</tr>";
        ...
        html += "<tr>";
	html += "<td nowrap>"+gui.formIcon(request.getContextPath(),"page-edit.png", "", "")+" "+gui.formLabel("name", "Status Name")+"</td>";
	html += "<td>"+gui.formInput("text", "name", 30, this.id != null? this.statusName: "", "", "")+"</td>";
	html += "</tr>";
	...
	html += "<td>&nbsp;</td>";
	html += "<td>";
	html += gui.formButton(request.getContextPath(), "button", "btnSave", "Save", "save.png", "onclick = \"staffStatus.save('code name');\"", "");
        if(this.id != null){
            html += gui.formButton(request.getContextPath(), "button", "btnDelete", "Delete", "delete.png", "onclick = \"staffStatus.purge("+this.id+",'"+this.statusName+"');\"", "");
        }
