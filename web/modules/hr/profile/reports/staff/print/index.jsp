...
<%
    ...
    try{
        ...
        String statusCode        = request.getParameter("staffStatus");
        
//        String outputForm = "html";
        String outputForm = "excel";
        
        String rptName = "staff";
        
        String webRootPath      = application.getRealPath("/").replace('\\', '/');
        String tempPath         = webRootPath+ "/tmp/reports/jasper/log/";
        String mainReportPath   = "";

        mainReportPath  = webRootPath+ "/reports/jasper/hr/"+ rptName+ ".jrxml";
        ...
        if(statusCode.trim().equals("") || statusCode == null){
            query   = " SELECT * FROM "+ session.getAttribute("comCode")+".viewstaffprofile ";
        }else{
            query   = " SELECT * FROM "+ session.getAttribute("comCode")+".viewstaffprofile WHERE statuscode = '"+statusCode+"' ";
        }
