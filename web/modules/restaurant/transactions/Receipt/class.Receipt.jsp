...
//            html += "</tr>";
            ...
            html += "<td colspan = \"3\" nowrap>"+ gui.formSelect("itemNo", ""+this.comCode+".ICITEMS", "ITEMCODE", "ITEMNAME", "", "CATCODE IN (SELECT CATCODE FROM "+this.comCode+".RTCATS)", this.id != null? this.tableNo: "", "onchange = \"invoice.getItemProfile();\"", false)+ "</td>";
            html += "</tr>";
