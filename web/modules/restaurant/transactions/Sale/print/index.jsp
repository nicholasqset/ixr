...
<%
    final class PrintRptReceipt{
        ...
        String pyNo     = request.getParameter("saleNo") != null && ! request.getParameter("saleNo").trim().equals("")? request.getParameter("saleNo"): null;
...
//                    html += "<td>&nbsp;</td>";
        ...
        public String getReportDetails(){
            ...
            html += "<td>"+ system.numberFormat(rtPyHdr.tender.toString())+ "</td>";
            html += "</tr>";
