...
//            html += "</tr>";
            ...
            html += "<td colspan = \"3\" nowrap>"+ gui.formSelect("itemNo", "ICITEMS", "ITEMCODE", "ITEMNAME", "", "CATCODE IN (SELECT CATCODE FROM RTCATS)", this.id != null? this.tableNo: "", "onchange = \"sale.getItemProfile();\"", true)+ "</td>";
            html += "</tr>";
