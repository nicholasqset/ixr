            ...
            var calendar = {
                getCalYear: function(){
                    new Ajax.Request(module.ajaxUrl ,{
                        method:'post',
                        parameters: 'function=getCalYear&fiscalYear='+ $F('fiscalYear'),
                        requestHeaders: { Accept: 'application/json'},
                        onSuccess: function(request) {
                            response = request.responseText.evalJSON();
                            if(typeof response.success === 'number' && response.success === 1){
                                
                                if(typeof response.pYearUi !== 'undefined' && $('tdPYear')) $('tdPYear').update(response.pYearUi);
                                ...
                                if(typeof response.message !== 'undefined'){
                                    ...
                                    g.error("An Unexpected error occured while retrieving record.", { header : ' ' ,life: 5, speedout: 2 });
                                }
                            }
                        }
                    });
                            ...
                            onSuccess: function(request) {
                                ...
                                if(typeof response.success==='number' && response.success===1){
                                    ...
                                    if(typeof response.message !== 'undefined'){
                                        ...
                                        g.error("Unexpected error occured while saving record.", { header : ' ' ,life: 5, speedout: 2 });
                                    }
                                }
                            }
			});
