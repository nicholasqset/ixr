...
final class Sections{
    ...
    String sectionCode  = request.getParameter("code");
    ...
    public String getGrid(){
        ...
        if(recordCount > 0){
            ...
            String orderBy = "DEPTNAME, SECTIONCODE ";
            String limitSql = "";
            ...
            try{
                ...
                while(rs.next()){
                    ...
                    String regionName       = rs.getString("DEPTNAME");
	...
	html += "</tr>";
        ...
        html += "<tr>";
	html += "<td>"+gui.formIcon(request.getContextPath(),"page.png", "", "")+" "+gui.formLabel("code", "Section Code")+"</td>";
	html += "<td>"+gui.formInput("text", "code", 10, this.id != null? this.sectionCode: "" , "", "")+"</td>";
	html += "</tr>";
        
        html += "<tr>";
	html += "<td>"+gui.formIcon(request.getContextPath(),"page-edit.png", "", "")+" "+gui.formLabel("name", "Section Name")+"</td>";
	html += "<td>"+gui.formInput("text", "name", 30, this.id != null? this.sectionName: "", "", "")+"</td>";
	html += "</tr>";
        
        html += "<tr>";
	html += "<td>&nbsp;</td>";
	html += "<td>";
	html += gui.formButton(request.getContextPath(), "button", "btnSave", "Save", "save.png", "onclick = \"sections.save('department code name');\"", "");
        if(this.id != null){
            html += gui.formButton(request.getContextPath(), "button", "btnDelete", "Delete", "delete.png", "onclick = \"sections.purge("+this.id+",'"+this.sectionName+"');\"", "");
        }
        ...
        try{
            ...
            if(this.id == null){
                ...
                query = "INSERT INTO "+this.table+" "
                    + "(ID, DEPTCODE, SECTIONCODE, SECTIONNAME)"
                    + "VALUES"
                    + "("
                    + id+","
                    + "'"+ this.deptCode+ "', "
