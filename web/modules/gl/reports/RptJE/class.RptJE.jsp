...
final class RptJE{
	...
	html += "</tr>";
        ...
        html += "<tr>";
	html += "<td width = \"15%\">"+ gui.formIcon(request.getContextPath(), "page-edit.png", "", "")+ gui.formLabel("account", " GL Account")+ "</td>";
        html += "<td>"+ gui.formSelect("account", comCode+".GLACCOUNTS", "ACCOUNTCODE", "ACCOUNTNAME", "", "", sys.getPeriodYear(comCode)+ "", "", true)+"</td>";
	html += "</tr>";
        
        html += "<tr>";
	html += "<td>"+ gui.formIcon(request.getContextPath(), "pencil.png", "", "")+ gui.formLabel("posted", " Posted")+ "</td>";
	html += "<td>"+ gui.formCheckBox("posted", "checked", "", "", "", "")+ "</td>";
	html += "</tr>";
	...
	html += "<td>&nbsp;</td>";
	html += "<td>";
        html += gui.formButton(request.getContextPath(), "button", "btnPrint", "Print", "printer.png", "onclick = \"rptJE.print('pYear pMonth'); return false;\"", "");
