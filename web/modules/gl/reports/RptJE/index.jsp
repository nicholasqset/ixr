                ...
                print: function(required){
                    if(module.validate(required)){
                        var printWindow = window.open(
                                './print?'+ Form.serialize('frmModule'), '', 'height=500, width=900, toolbar=no, menubar=no, directories=no, location=no, scrollbars=yes, status=no, resizable=no, fullscreen=no, top=200, left=200');
                        printWindow.focus();
                    }
                }
            };
