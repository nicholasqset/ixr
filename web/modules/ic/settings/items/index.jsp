            ...
            var items = {
                searchSupplier: function(){
                    ...
                    if(count <= 0){
                        ...
                        new Ajax.Autocompleter(
                                ...
                                minChars   : 2,
                                frequency  : 1.0,
                                afterUpdateElement : items.setSupplier
                            });
                    }
                },
                setSupplier: function(text, supplier){
                    if(supplier.id !== ''){
                        ...
                        items.getSupplierProfile(supplier.id);
                        /*
                         * items.getInEntries();
                         */
                    }
                    ...
                    new Ajax.Request(module.ajaxUrl, {
                        ...
                        onSuccess: function(request) {
                            ...
                            if(typeof response.success === 'number' && response.success === 1){
                                ...
                                if(typeof response.fullName !== 'undefined' && $('spFullName')) $('spFullName').update(response.fullName);
