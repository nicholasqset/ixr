...
final class ItemPicture{
    ...
    String table        = comCode+".ICITEMPHOTOS";
...
//        html += "<form name = \"frmModule\" id = \"frmModule\" method = \"post\" enctype = \"multipart/form-data\" target = \"_blank\">";
	...
	html += "<td width = \"35%\">"+ gui.formInput("text", "code", 20, this.id != null? this.itemCode: "" , "", "")+"<span class = \"fade\"> i.e bar code</span></td>";
	html += "<td rowspan = \"10\">";
    ...
    public Boolean hasPhoto(String itemCode){
        ...
        if(this.id != null){
            ...
            try{
                ...
                String query = "SELECT COUNT(*)CT FROM ICITEMPHOTOS WHERE ITEMCODE = '"+itemCode+"'";
                ResultSet rs = stmt.executeQuery(query);
                while(rs.next()){
                    count      = rs.getInt("CT");		
                }
    ...
    public Object purgePhoto() throws Exception{
         ...
         try{
            ...
            if(this.itemCode != null && ! this.itemCode.trim().equals("")){
                String query = "DELETE FROM ICITEMPHOTOS WHERE ITEMCODE = '"+this.itemCode+"'";
