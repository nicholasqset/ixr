            ...
            var itemsImport = {                
                import: function(required){
                    if(module.validate(required)){
                        if(confirm('Import items? Please note this will affect your current item status')){
...
//                        g.info("Import of '"+count+"' records successfully made", { header: ' ' , life: 5, speedout: 2 });
                        g.info("Import of records successfully made", { header: ' ' , life: 5, speedout: 2 });
                    }else{
