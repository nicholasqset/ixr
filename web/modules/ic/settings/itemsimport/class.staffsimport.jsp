...
//        html += "<form name = \"frmModule\" id = \"frmModule\" method = \"post\" enctype = \"multipart/form-data\" target = \"_blank\">";
	...
	html += "<td><input type = \"file\" name = \"impfile\" id = \"impfile\" onchange = \"itemsImport.import(' ');\" > <span><a href = \"./template/items_template.xls\">template</a></span></td>";
	html += "</tr>";
