...
//         FileInputStream fis=new FileInputStream(new File("C:\\demo\\student.xls"));  
                ...
                while (itr.hasNext()) {
                    ...
                    while (cellIterator.hasNext()) {
                        ...
                        switch (index) {
                            case 0:
                                itemCode_ = cell.getStringCellValue();
                                break;
                            case 1:
                            ...
                            case 3:
                                ...
                                break;
                            case 4:
                                expdt = cell.getStringCellValue().toString();
                                break;
                        }
...
//                    int itemCode__ = itemCode_.intValue();
                    String itemCode = itemCode_ + "";

                    itemCode = itemCode != null ? itemCode.replaceAll("(?<=^\\d+)\\.0*$", "") : "";

                    system.logV2("itemCode==" + itemCode + ", itemName==" + itemName + ", qty==" + qty + ", unitCost==" + unitPrice);
                    ...
                    if (idExisting == null) {
                        ...
                        query = "INSERT INTO " + comCode + ".icitems "
                                ...
                                + "unitprice, stocked, qty, mfgdt, expdt, wsprice, minlevel, audituser, auditdate, audittime, auditipadr"
                                + ") "
                                + "VALUES"
                                + "("
                                + id + ","
