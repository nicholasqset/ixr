...
//    String itemCode         = request.getParameter("item");
	...
	html += "<div style=\"padding-left: 10px; padding-top: 37px; border: 0;\" >";
        if(! posted){
            html += gui.formButton(request.getContextPath(), "button", "btnSave", "Save", "save.png", "onclick = \"py.save('entryDate pyDesc pYear pMonth itemNo'); return false;\"", "");
        }
	...
	html += "</div>";
        ...
        html += "initTabs(\'dhtmlgoodies_tabView1\', Array(\'New Stock\'), 0, 625, 420, Array(false));";
	...
	html += "<td colspan = \"3\">"+ gui.formInput("text", "pyDesc", 30, this.id != null? this.pyDesc: "** NEW STOCK **", "", "")+"</td>";
	html += "</tr>";
...
//	html += "</tr>";
        ...
        html += "<td nowrap>"+ gui.formAutoComplete("itemNo", 17, "", "py.searchItem", "itemNoHd", "")+ "<span class = \"fade\"> e.g bar code </span></td>";
...
//        ICItem iCItem = new ICItem(this.itemCode);
        ...
        if(this.pyNo != null){
            try{
                ...
                if(this.sid == null){
                    ...
                    String lineNo = system.getNextNo("ICPYDTLS", "LINENO", "PYNO = '"+ this.pyNo+ "'", "", 7);
                    
                    query = "INSERT INTO "+comCode+".ICPYDTLS "
                            + "("
    ...
    public Object editPyDtls() throws Exception{
        ...
        Sys system = new Sys();
        Gui gui = new Gui();
        if(system.recordExists(comCode+".ICPYDTLS", "ID = "+ this.sid +"")){
            try{
                Connection conn = ConnectionProvider.getConnection();
                Statement stmt = conn.createStatement();
    ...
    public Object post() throws Exception{
        ...
        try{
            ...
            if(! pyPosted.equals("1")){
                rts = 0;
                msg = "New Stock could not be posted. "+ pyPosted;
            }
...
//                String query = "UPDATE "+this.table+" SET POSTED = NULL WHERE ID = "+this.id;
                ...
                if(rtp == 1){
                    obj.put("success", new Integer(1));
                    obj.put("message", "New Stock successfully posted.");
                }else{
                    obj.put("success", new Integer(0));
                    obj.put("message", "An error occured while posting New Stock.");
                }
            }else{
                obj.put("success", new Integer(0));
                obj.put("message", msg);
