...
final class FS{
    ...
    public String getGrid(){
        ...
        if(recordCount > 0){
            ...
            String orderBy = "ACADEMICYEAR DESC, TERMCODE DESC, FORMCODE DESC, STUDTYPECODE DESC ";
            String limitSql = "";
	...
	html += gui.formButton(request.getContextPath(), "button", "btnSave", "Save", "save.png", "onclick = \"fs.save('academicYear term studentForm studentType item amount'); return false;\"", "");
	...
	html += "</div>";
        ...
        html += "initTabs(\'dhtmlgoodies_tabView1\', Array(\'Fees Structure\'), 0, 625, 420, Array(false));";
        html += "</script>";
