        ...
        <script type="text/javascript">
            ...
            var perStudent = {
                ...
                getInvItems: function(){
                    module.execute('getInvItems', Form.serialize('frmModule'), 'dvInvItems');
                },
                    ...
                    new Ajax.Request(module.ajaxUrl ,{
                            ...
                            onSuccess: function(request) {
                                ...
                                if(typeof response.success === 'number' && response.success===1){
                                    ...
                                    if(typeof response.invDescription !== 'undefined' && $('invDescription')) $('invDescription').value = response.invDescription;
			...
			new Ajax.Request(module.ajaxUrl ,{
                            ...
                            onSuccess: function(request) {
                                ...
                                if(typeof response.success==='number' && response.success===1){
                                    g.info(response.message, { header : ' ' ,life: 5, speedout: 2  });
                                    if($('dvInvItems')) perStudent.getInvItems();
                                }else{
                                    if(typeof response.message !== 'undefined'){
                                        g.error(response.message, { header : ' ' ,life: 5, speedout: 2 });
                                    }else{
