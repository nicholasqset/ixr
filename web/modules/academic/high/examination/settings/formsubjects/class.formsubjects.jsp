...
final class FormSubjects{
    ...
    Integer minFormSbjs     = request.getParameter("minimumSubjects") != null? Integer.parseInt(request.getParameter("minimumSubjects")): null;
...
//            gridSql = "SELECT * FROM "+this.view+" "+filterSql+" ORDER BY FORMCODE LIMIT "
//                    + session.getAttribute("startRecord")
//                    + " , "
//                    + session.getAttribute("maxRecord");
            
            String orderBy = "FORMCODE ";
            String limitSql = "";
            ...
            try{
                ...
                while(rs.next()){
                    ...
                    Integer minFormSbjs     = rs.getInt("MINFORMSBJS");
        ...
        if(this.id != null){
            ...
            try{
                ...
                while(rs.next()){
                    ...
                    this.minFormSbjs    = rs.getInt("MINFORMSBJS");	
                }
            }catch (SQLException e){
                html += e.getMessage();
            }catch(Exception e){
	...
	html += "<td>"+gui.formInput("text", "minimumSubjects", 5, this.id != null? ""+ this.minFormSbjs: "" , "", "")+"</td>";
	html += "</tr>";
        
        html += "<tr>";
	html += "<td>&nbsp;</td>";
	html += "<td>";
	html += gui.formButton(request.getContextPath(), "button", "btnSave", "Save", "save.png", "onclick = \"formSubjects.save('studentForm subjectGroup minimumSubjects');\"", "");
        if(this.id != null){
            html += gui.formButton(request.getContextPath(), "button", "btnDelete", "Delete", "delete.png", "onclick = \"formSubjects.purge("+this.id+",'"+ formName+ "');\"", "");
        }
