...
final class CoreSubjects{
    ...
    public String getGrid(){
        ...
        if(recordCount > 0){
            ...
            gridSql = "SELECT * FROM "+this.view+" "+filterSql+" ORDER BY FORMCODE, SUBJECTNAME LIMIT "
	...
	html += "</tr>";
        ...
        html += "<tr>";
	html += "<td nowrap>"+ gui.formIcon(request.getContextPath(),"page.png", "", "")+ gui.formLabel("subject", " Subject")+ "</td>";
        html += "<td>"+ gui.formSelect("subject", "HGSUBJECTS", "SUBJECTCODE", "SUBJECTNAME", "ID", "", this.id != null? this.subjectCode: "", "", false)+ "</td>";
	html += "</tr>";
        
        html += "<tr>";
	html += "<td>&nbsp;</td>";
	html += "<td>";
	html += gui.formButton(request.getContextPath(), "button", "btnSave", "Save", "save.png", "onclick = \"coreSubjects.save('studentForm subject');\"", "");
        if(this.id != null){
            html += gui.formButton(request.getContextPath(), "button", "btnDelete", "Delete", "delete.png", "onclick = \"coreSubjects.purge("+this.id+",'"+ subjectName+ "');\"", "");
        }
