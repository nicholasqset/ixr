    ...
    final class Staffs {
        ...
        public String getGrid() {
            ...
            try {
                ...
                String query = "SELECT COUNT(*) FROM " + this.view;
            ...
            gridSql = "SELECT * FROM " + this.view + " " + filterSql + " ORDER BY STAFFNO LIMIT "
...
//	html += gui.formButton(request.getContextPath(), "button", "btnSave", "Save", "save.png", "onclick = \"staffs.save('staffNo staffNoHd firstName lastName gender dob country'); return false;\"", "");
        ...
        public JSONObject getStaffProfile() throws Exception {
