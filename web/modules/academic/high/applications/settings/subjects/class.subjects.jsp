...
final class Subjects{
    String table        = "HGPRYSUBJECTS";
    String view         = "VIEWPRYSUBJECTS";
    ...
    public String getGrid(){
        ...
        if(recordCount > 0){
            ...
            gridSql = "SELECT * FROM "+this.view+" "+filterSql+" ORDER BY EXAMNAME, SUBJECTCODE LIMIT "
    ...
    public String getModule(){
        ...
        html += "<tr>";
	html += "<td width = \"15%\" nowrap>"+ gui.formIcon(request.getContextPath(),"book.png", "", "")+ gui.formLabel("exam", " Examination")+ "</td>";
	html += "<td>"+ gui.formSelect("exam", "HGPRYEXAMS", "EXAMCODE", "EXAMNAME", "", "", this.id != null? this.examCode: "", "", false)+ "</td>";
	html += "</tr>";
	...
	html += "<td>"+gui.formInput("text", "name", 35, this.id != null? this.subjectName: "", "", "")+"</td>";
	html += "</tr>";
        
        html += "<tr>";
	html += "<td>&nbsp;</td>";
	html += "<td>";
	html += gui.formButton(request.getContextPath(), "button", "btnSave", "Save", "save.png", "onclick = \"subjects.save('exam code name');\"", "");
        if(this.id != null){
        ...
        try{
            ...
            if(this.id == null){
                ...
                query = "INSERT INTO "+this.table+" "
                    + "(ID, EXAMCODE, SUBJECTCODE, SUBJECTNAME)"
                    + "VALUES"
                    + "("
                    + id+","
                    + "'"+ this.examCode+ "',"
