...
//                    + session.getAttribute("maxRecord");
        ...
        public String getBioDataTab() {
            ...
            if (this.id != null) {
                ...
                this.lastName = hGStudentProfile.lastName;
                this.genderCode = hGStudentProfile.genderCode;
                this.dob = hGStudentProfile.dob;
                this.countryCode = hGStudentProfile.countryCode;
                this.nationalId = hGStudentProfile.nationalId;
                this.passportNo = hGStudentProfile.passportNo;
                this.physChald = hGStudentProfile.physChald;
                this.disabCode = hGStudentProfile.disabCode;
                this.postalAdr = hGStudentProfile.postalAdr;
                this.postalCode = hGStudentProfile.postalCode;
                this.physicalAdr = hGStudentProfile.physicalAdr;
                this.telephone = hGStudentProfile.telephone;
                this.cellphone = hGStudentProfile.cellphone;
                this.email = hGStudentProfile.email;
                this.admGrp = hGStudentProfile.admGrp;
                this.streamCode = hGStudentProfile.streamCode;
                this.studPrdCode = hGStudentProfile.studPrdCode;
                this.studTypeCode = hGStudentProfile.studTypeCode;
                this.statusCode = hGStudentProfile.statusCode;
        ...
        public Object getStudentProfile() throws Exception {
            ...
            if (this.studentNo == null || this.studentNo.equals("")) {
                ...
                obj.put("middleName", hGStudentProfile.middleName);
                obj.put("lastName", hGStudentProfile.lastName);
                obj.put("gender", hGStudentProfile.genderCode);

                SimpleDateFormat originalFormat = new SimpleDateFormat("yyyy-MM-dd");
                SimpleDateFormat targetFormat = new SimpleDateFormat("dd-MM-yyyy");

                try {
                    java.util.Date dob = originalFormat.parse(hGStudentProfile.dob);
                    hGStudentProfile.dob = targetFormat.format(dob);
                } catch (ParseException e) {
                    obj.put("success", new Integer(0));
                    obj.put("message", e.getMessage());
                }

                obj.put("dob", hGStudentProfile.dob);
                obj.put("country", hGStudentProfile.countryCode);
                obj.put("physChald", hGStudentProfile.physChald);
                obj.put("disability", hGStudentProfile.disabCode);
                obj.put("postalAdr", hGStudentProfile.postalAdr);
                obj.put("postalCode", hGStudentProfile.postalCode);
                obj.put("physicalAdr", hGStudentProfile.physicalAdr);
                obj.put("telephone", hGStudentProfile.telephone);
                obj.put("cellphone", hGStudentProfile.cellphone);
                obj.put("email", hGStudentProfile.email);

                obj.put("stream", hGStudentProfile.streamCode);
                obj.put("studentPeriod", hGStudentProfile.studPrdCode);
                obj.put("studentType", hGStudentProfile.studTypeCode);
                obj.put("studentStatus", hGStudentProfile.statusCode);
            ...
            try {
                ...
                if (saved == 1) {
                    ...
                    if (this.id == null && this.autoStudentNo == 1) {
                        stmt.executeUpdate("UPDATE " + this.comCode + ".HGSTUDNOS SET CURNO = (CURNO + 1)");
                    }
        ...
        public String getNextStudentNo() {
            ...
            if (curNo == null) {
                ...
                this.initStudNo(highCalendar.academicYear);
            ...
            String academicYear = "" + highCalendar.academicYear;
        ...
        public Integer initStudNo(Integer academicYear) {
            ...
            try {
                ...
                String query = "INSERT INTO " + this.comCode + ".HGSTUDNOS "
