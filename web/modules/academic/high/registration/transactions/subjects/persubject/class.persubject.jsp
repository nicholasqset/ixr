...
final class PerSubject{
	...
	html += "<td width = \"15%\" nowrap>"+ gui.formIcon(request.getContextPath(),"calendar.png", "", "")+ gui.formLabel("academicYear", " Academic Year")+ "</td>";
        html += "<td>"+ gui.formSelect("academicYear", "HGACADEMICYEARS", "ACADEMICYEAR", "", "ACADEMICYEAR DESC", "", ""+ highCalendar.academicYear, "onchange = \"perSubject.getStudents();\"", false)+ "</td>";
	html += "</tr>";
	...
	html += "<td>"+ gui.formSelect("studentForm", "HGFORMS", "FORMCODE", "FORMNAME", "", "", "", "onchange = \"perSubject.getStudents();\"", false)+ "</td>";
	html += "</tr>";
    ...
    public String getStudents(){
        ...
        if(system.recordExists("VIEWHGREGISTRATION", "ACADEMICYEAR = "+ this.academicYear+ " AND TERMCODE = '"+ this.termCode+ "' AND FORMCODE = '"+ this.formCode+ "' ")){
            ...
            try{
                ...
                String query = "SELECT * FROM VIEWHGREGISTRATION WHERE ACADEMICYEAR = "+ this.academicYear+ " AND TERMCODE = '"+ this.termCode+ "' AND FORMCODE = '"+ this.formCode+ "' ";
