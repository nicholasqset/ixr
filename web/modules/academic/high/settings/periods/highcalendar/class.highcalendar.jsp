...
//            gridSql = "SELECT * FROM "+this.view+" "+filterSql+" ORDER BY ACADEMICYEAR DESC, TERMCODE DESC LIMIT "
//                    + session.getAttribute("startRecord")
//                    + " , "
//                    + session.getAttribute("maxRecord");
            
            String orderBy = "ACADEMICYEAR DESC, TERMCODE DESC ";
            String limitSql = "";
	...
	html += "<td>&nbsp;</td>";
	html += "<td>";
	html += gui.formButton(request.getContextPath(), "button", "btnSave", "Save", "save.png", "onclick = \"highCalendar.save('academicYear term startDate endDate');\"", "");
        if(this.id != null){
            html += gui.formButton(request.getContextPath(), "button", "btnDelete", "Delete", "delete.png", "onclick = \"highCalendar.purge("+this.id+",'"+this.active+"');\"", "");
        }
