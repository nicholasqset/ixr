...
//                    + session.getAttribute("maxRecord");
    ...
    public String getModule(){
        ...
        html += "<tr>";
	html += "<td width = \"15%\" nowrap>"+ gui.formIcon(request.getContextPath(),"page.png", "", "")+ gui.formLabel("code", " Form Code")+ "</td>";
	html += "<td>"+gui.formInput("text", "code", 10, this.id != null? this.formCode: "" , "", "")+"</td>";
	html += "</tr>";
        
        html += "<tr>";
	html += "<td>"+gui.formIcon(request.getContextPath(),"page-edit.png", "", "")+ gui.formLabel("name", " Form Name")+"</td>";
	html += "<td>"+gui.formInput("text", "name", 25, this.id != null? this.formName: "", "", "")+"</td>";
	html += "</tr>";
	...
	html += "<td>&nbsp;</td>";
	html += "<td>";
	html += gui.formButton(request.getContextPath(), "button", "btnSave", "Save", "save.png", "onclick = \"studentForms.save('code name studentYear');\"", "");
        if(this.id != null){
            html += gui.formButton(request.getContextPath(), "button", "btnDelete", "Delete", "delete.png", "onclick = \"studentForms.purge("+this.id+",'"+this.formName+"');\"", "");
        }
        ...
        try{
            ...
            if(this.id == null){
                ...
                query = "INSERT INTO "+this.table+" "
                    + "(ID, FORMCODE, FORMNAME, STUDYRCODE)"
                    + "VALUES"
                    + "("
                    + id+","
                    + "'"+ this.formCode+ "',"
