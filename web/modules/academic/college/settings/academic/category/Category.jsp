            ...
            if (recordCount > 0) {
                ...
                try {
                    ...
                    while (rs.next()) {
                        ...
                        String progCode = rs.getString("cat_code");
                        String progName = rs.getString("cat_name");
        ...
        public String getModule() {
            ...
            if (this.id != null) {
                ...
                try {
                    ...
                    while (rs.next()) {
                        this.progCode = rs.getString("cat_code");
                        this.progName = rs.getString("cat_name");
                    }
                } catch (SQLException e) {
            ...
            try {
                ...
                if (this.id == null) {
                    ...
                    query = "UPDATE " + this.table + " SET "
                            + "cat_code   = '" + this.progCode + "',"
                            + "cat_name   = '" + this.progName + "'"
                            + "WHERE ID     = " + this.id;
                }
