...
<html>
    ...
    <body>
        ...
        <script type="text/javascript">
            ...
            var registration = {
                searchStudent: function(){
                    ...
                    if(count <= 0){
                        ...
                        new Ajax.Autocompleter(
                                ...
                                minChars   : 2,
                                frequency  : 1.0,
                                afterUpdateElement : registration.setStudent
                            });
                    }
                },
                setStudent: function(text, student){
                    if(student.id !== ''){
                        ...
                        registration.getStudentProfile(student.id);
                    }
                },
                    ...
                    new Ajax.Request(module.ajaxUrl ,{
                        ...
                        onSuccess: function(request) {
                            ...
                            if(typeof response.success === 'number' && response.success === 1){
                                ...
                                if(typeof response.feesBalance !== 'undefined' && $('feesBalance')) $('feesBalance').value = response.feesBalance;
			...
			new Ajax.Request(module.ajaxUrl ,{
                            method:'post',
                            parameters: 'function=save&feesBalance='+ feesBalance+ '&'+ data,
                            requestHeaders: { Accept: 'application/json'},
                            onSuccess: function(request) {
                                response = request.responseText.evalJSON();
                                if(typeof response.success==='number' && response.success===1){
