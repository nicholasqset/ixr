...
final class Subjects{
    HttpSession session     = request.getSession();
        ...
        String table            = comCode+".PRSUBJECTS";
...
//            gridSql = "SELECT * FROM "+ this.table+ " "+filterSql+" ORDER BY SUBJECTCODE LIMIT "
//                    + session.getAttribute("startRecord")
//                    + " , "
//                    + session.getAttribute("maxRecord");
            
            String orderBy = "SUBJECTCODE ";
            String limitSql = "";
    ...
    public String getModule(){
        ...
        html += "<tr>";
	html += "<td width = \"15%\" nowrap>"+ gui.formIcon(request.getContextPath(),"page.png", "", "")+ gui.formLabel("code", " Subject Code")+ "</td>";
	...
	html += "<td>&nbsp;</td>";
	html += "<td>";
	html += gui.formButton(request.getContextPath(), "button", "btnSave", "Save", "save.png", "onclick = \"subjects.save('code name');\"", "");
