...
final class PresetExam{
    ...
    String formCode         = request.getParameter("studentClass");
	...
	html += gui.formButton(request.getContextPath(), "button", "btnProcess", "Preset", "cog.png", "onclick = \"presetExam.process('academicYear term studentClass exam subject'); return false;\"", "");
