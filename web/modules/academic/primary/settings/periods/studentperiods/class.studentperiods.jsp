...
final class StudentPeriods{
    ...
    String studPrdCode  = classCode + termCode;
...
//            gridSql = "SELECT * FROM "+this.view+" "+filterSql+" ORDER BY STUDYRLEVEL, STUDPRDCODE LIMIT "
//                    + session.getAttribute("startRecord")
//                    + " , "
//                    + session.getAttribute("maxRecord");
            
            String orderBy = "STUDYRLEVEL, STUDPRDCODE ";
            String limitSql = "";
	...
	html += "<td>&nbsp;</td>";
	html += "<td>";
	html += gui.formButton(request.getContextPath(), "button", "btnSave", "Save", "save.png", "onclick = \"studentPeriods.save('studentClass term name');\"", "");
        if(this.id != null){
