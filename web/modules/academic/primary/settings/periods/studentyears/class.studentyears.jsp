...
final class StudentYears{
    HttpSession session     = request.getSession();
        ...
        String table            = comCode+".PRSTUDYEARS";
...
//            gridSql = "SELECT * FROM "+this.table+" "+filterSql+" ORDER BY STUDYRLEVEL LIMIT "
...
//                    + session.getAttribute("maxRecord");
    ...
    public String getModule(){
        ...
        yearLevels.put("0", "Level 0");
        yearLevels.put("1", "Level 1");
        yearLevels.put("2", "Level 2");
        yearLevels.put("3", "Level 3");
        yearLevels.put("4", "Level 4");
        yearLevels.put("5", "Level 5");
        yearLevels.put("6", "Level 6");
        yearLevels.put("7", "Level 7");
        yearLevels.put("8", "Level 8");
	...
	html += "</tr>";
        ...
        html += "<tr>";
	html += "<td>"+gui.formIcon(request.getContextPath(),"page-white-edit.png", "", "")+ gui.formLabel("studYrLevel", " Class Level")+"</td>";
