...
final class Classes{
    ...
    String studYrCode   = request.getParameter("studentYear");
...
//            gridSql = "SELECT * FROM "+ this.view+ " "+filterSql+" ORDER BY STUDYRLEVEL LIMIT "
//                    + session.getAttribute("startRecord")
//                    + " , "
//                    + session.getAttribute("maxRecord");
            
            String orderBy = "STUDYRLEVEL ";
            String limitSql = "";
...
//        HashMap classYears = system.getArray("SELECT STUDYRCODE, STUDYRNAME FROM PRSTUDYEARS ORDER BY STUDYRLEVEL ");
        ...
        html += "<tr>";
	html += "<td width = \"15%\" nowrap>"+ gui.formIcon(request.getContextPath(),"page.png", "", "")+ gui.formLabel("code", " Class Code")+ "</td>";
	html += "<td>"+gui.formInput("text", "code", 10, this.id != null? this.classCode: "" , "", "")+"</td>";
	html += "</tr>";
        
        html += "<tr>";
	html += "<td>"+gui.formIcon(request.getContextPath(),"page-edit.png", "", "")+ gui.formLabel("name", " Class Name")+"</td>";
	html += "<td>"+gui.formInput("text", "name", 25, this.id != null? this.className: "", "", "")+"</td>";
	html += "</tr>";
...
//	html += "<td>"+ gui.formArraySelect("studentYear", 120, classYears, this.id != null? this.studYrCode: "", false, "", true)+ "</td>";
	...
	html += "<td>&nbsp;</td>";
	html += "<td>";
	html += gui.formButton(request.getContextPath(), "button", "btnSave", "Save", "save.png", "onclick = \"classes.save('code name studentYear');\"", "");
        if(this.id != null){
            html += gui.formButton(request.getContextPath(), "button", "btnDelete", "Delete", "delete.png", "onclick = \"classes.purge("+this.id+",'"+this.className+"');\"", "");
        }
