...
final class Receipts{
    ...
    String view             = comCode+".VIEWPRRECEIPTS";
...
//            gridSql = "SELECT * FROM "+this.view+" "+filterSql+" ORDER BY RCPTNO DESC LIMIT "
...
//                    + session.getAttribute("maxRecord");
	...
	html += "<div style=\"padding-left: 10px; padding-top: 37px; border: 0;\" >";
        ...
        if(this.id == null){
            html += gui.formButton(request.getContextPath(), "button", "btnSave", "Save", "save.png", "onclick = \"receipts.save('studentNo academicYear term receiptDesc receiptDate payMode amount'); return false;\"", "");
        }
	...
	html += "<td width = \"15%\">"+ gui.formIcon(request.getContextPath(),"user-properties.png", "", "")+ gui.formLabel("studentNo", " Student No")+ "</td>";
        html += "<td width = \"35%\">"+ gui.formAutoComplete("studentNo", 15, this.id != null? this.studentNo: "", "receipts.searchStudent", "studentNoHd", this.id != null? this.studentNo: "")+ "</td>";
        ...
        try{
            ...
            if(this.id == null){
                ...
                query = "INSERT INTO "+ this.table+ " "
                            ...
                            + "RCPTNO, RCPTDESC, RCPTDATE, "
                            + "PMCODE, DOCNO, BKBRANCHCODE, AMOUNT, "
