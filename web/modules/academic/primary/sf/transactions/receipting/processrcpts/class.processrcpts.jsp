...
<%
    ...
    final class ProcessRcpts {
        ...
        public String getModule() {
            ...
            html += gui.formButton(request.getContextPath(), "button", "btnProcess", "Process", "cog.png", "onclick = \"procRcpts.process('academicYear term studentClass studentType item amount'); return false;\"", "");
        ...
        public String getReceiptsTab() {
            ...
            html += "<td>" + gui.formSelect("academicYear", "" + this.comCode + ".PRACADEMICYEARS", "ACADEMICYEAR", "", "ACADEMICYEAR DESC", "", "" + primaryCalendar.academicYear, "onchange = \"procRcpts.getReceipts();\"", false) + "</td>";
            html += "</tr>";

            html += "<tr>";
            html += "<td>" + gui.formIcon(request.getContextPath(), "calendar.png", "", "") + gui.formLabel("term", " Term") + "</td>";
            html += "<td>" + gui.formSelect("term", "" + this.comCode + ".PRTERMS", "TERMCODE", "TERMNAME", "", "", primaryCalendar.termCode, "onchange = \"procRcpts.getReceipts();\"", false) + "</td>";
            html += "</tr>";

            html += "<tr>";
            html += "<td>" + gui.formIcon(request.getContextPath(), "calendar.png", "", "") + gui.formLabel("studentClass", " Student Class") + "</td>";
            html += "<td>" + gui.formSelect("studentClass", "" + this.comCode + ".VIEWPRCLASSES", "CLASSCODE", "CLASSNAME", "", "", "", "onchange = \"procRcpts.getReceipts();\"", false) + "</td>";
            html += "</tr>";
        ...
        public String getReceipts() {
            ...
            if (sys.recordExists("" + this.comCode + ".VIEWPRVERFDRCPTS", "ACADEMICYEAR = " + this.academicYear + " AND TERMCODE = '" + this.termCode + "' AND STUDENTNO IN (SELECT STUDENTNO FROM " + this.comCode + ".VIEWPRSTUDENTPROFILE WHERE CLASSCODE = '" + this.classCode + "') ")) {
                ...
                try {
                    ...
                    String query = "SELECT * FROM " + this.comCode + ".VIEWPRVERFDRCPTS WHERE ACADEMICYEAR = " + this.academicYear + " AND TERMCODE = '" + this.termCode + "' AND STUDENTNO IN (SELECT STUDENTNO FROM " + this.comCode + ".VIEWPRSTUDENTPROFILE WHERE CLASSCODE = '" + this.classCode + "')  ORDER BY STUDENTNO";
