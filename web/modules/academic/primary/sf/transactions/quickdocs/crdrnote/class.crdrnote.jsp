...
final class CrDrNote{
    String table            = "PRQDHDR";
    String view             = "VIEWPRQDHEADER";
...
//                    String amountLbl = system.getOne("PRQDDTLS", "SUM(AMOUNT)", "DOCNO = '"+ docNo+ "'");
                    String amountLbl = system.getOneAgt("PRQDDTLS", "SUM", "AMOUNT", "SM", "DOCNO = '"+ docNo+ "'");
    ...
    public String getQDItems(){
        ...
        if(system.recordExists("VIEWPRQDDETAILS", filterSql)){
            ...
            try{
                ...
                String query = "SELECT * FROM VIEWPRQDDETAILS WHERE "+ filterSql+ "ORDER BY ITEMNAME";
    ...
    public Object editQDDtls(){
        ...
        Sys sys = new Sys();
        Gui gui = new Gui();
        if(system.recordExists("PRQDDTLS", "ID = "+ this.sid +"")){
            try{
                
                Connection conn = ConnectionProvider.getConnection();
                Statement stmt = conn.createStatement();
                
                String query = "SELECT * FROM VIEWPRQDDETAILS WHERE ID = "+ this.sid +"";
                ResultSet rs = stmt.executeQuery(query);
        ...
        if(docNo != null){
            try{
                ...
                if(this.sid == null){
                    ...
                    Integer sid = system.generateId("PRQDDTLS", "ID");

                    query = "INSERT INTO PRQDDTLS "
...
//        docNoMax = docNoMax.replace("^0+(?!$)", " ");
    ...
    public Object purge(){
         ...
         try{
            ...
            if(this.id != null){
                String query = "DELETE FROM PRQDDTLS WHERE ID = "+this.id;
         ...
         if(this.docNo != null && ! this.docNo.trim().equals("")){
             if(system.recordExists("VIEWPRQDDETAILS", filterSql)){
                 try{
                    ...
                    String query = "SELECT * FROM VIEWPRQDDETAILS WHERE "+ filterSql;
                    ...
                    while(rs.next()){
                        ...
                        Integer obsCreated = primarySchool.createPrObs(studentNo, academicYear, termCode, docNo, docDesc, this.docType, docDate, itemCode, amount, session, request);
