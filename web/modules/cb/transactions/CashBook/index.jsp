    ...
    <body>
        ...
        <script type="text/javascript">
            ...
            var cb = {
                    ...
                    if(count <= 0){
                        ...
                        new Ajax.Autocompleter(
                                'batchNo', getResultTo, module.ajaxUrl, {
                                    ...
                                    minChars   : 2,
                                    frequency  : 1.0,
                                    afterUpdateElement : cb.setBatch
                                }
                            );
                    }
                },
                    ...
                    new Ajax.Request(module.ajaxUrl, {
                        ...
                        onSuccess: function(request) {
                            ...
                            if(typeof response.success === 'number' && response.success === 1){
                                ...
                                if(typeof response.batchBank !== 'undefined' && $('tdBatchSource')) $('tdBatchSource').update(response.batchBank);
                ...
                searchGLAccount: function(){
                    ...
                    if(count <= 0){
                        ...
                        new Ajax.Autocompleter(
                                ...
                                minChars   : 2,
                                frequency  : 1.0,
                                afterUpdateElement : cb.setAccount
                            });
                    }
                },
                ...
                getCbEntries: function(){
                    module.execute('getCbEntries', Form.serialize('frmModule'), 'dvJeEntries');
                },
			...
			new Ajax.Request(module.ajaxUrl, {
                            ...
                            onSuccess: function(request) {
                                ...
                                if(typeof response.success==='number' && response.success===1){
                                    ...
                                    if($('dvJeEntries')) cb.getCbEntries();
                 ...
                 editCbDtls: function(sid){
                    new Ajax.Request(module.ajaxUrl, {
                        method:'post',
                        parameters: 'function=editCbDtls&sid='+ sid,
                        requestHeaders: { Accept: 'application/json'},
                        onSuccess: function(request) {
                            response = request.responseText.evalJSON();
                            if(typeof response.success === 'number' && response.success===1){
                                ...
                                if(typeof response.sidUi !== 'undefined' && $('dvCBEntrySid')) $('dvCBEntrySid').update(response.sidUi);
                                if(typeof response.reference !== 'undefined' && $('reference')) $('reference').value = response.reference;
                                if(typeof response.referenceDesc !== 'undefined' && $('referenceDesc')) $('referenceDesc').value = response.referenceDesc;
                                if(typeof response.documentType !== 'undefined' && $('documentType')) $('documentType').value = response.documentType;
