...
final class Batch{
    String table        = "CBBATCHES";
    String view         = "VIEWCBBATCHES";
            ...
            try{
                ...
                while(rs.next()){
                    ...
                    if(rtp == 1){
                        ...
                        rtpUi = gui.formCheckBox("rtp_"+ id, "", "", "onchange = \"batch.rtp("+ id+ ", "+ batchNo+ ", '"+ batchDesc+ "');\"", "", "");
                    }
                    ...
                    if(posted == 1){
                        ...
                        if(rtp == 1){
                            postedUi = gui.formCheckBox("posted_"+ id, "", "", "onchange = \"batch.post("+ id+ ", "+ batchNo+ ", '"+ batchDesc+ "');\"", "", "");
                        }else{
//                            postedUi = "Open";
                    ...
                    String drTotal_ = system.getOneAgt("CBDTLS", "SUM", "DRAMOUNT", "SM", "BATCHNO = "+ batchNo);
                    String crTotal_ = system.getOneAgt("CBDTLS", "SUM", "CRAMOUNT", "SM", "BATCHNO = "+ batchNo);                    
                    ...
                    html += "<td>"+ rtpUi+ "</td>";
                    html += "<td>"+ postedUi+ "</td>";
                    html += "<td>"+ system.numberFormat(drTotal_)+ "</td>";
                    html += "<td>"+ system.numberFormat(crTotal_)+ "</td>";
                    html += "<td>"+ edit+ "</td>";
                    html += "</tr>";
	...
	html += "<td>"+ gui.formSelect("bankBranch", "VIEWFNCOBANKS", "BKBRANCHCODE", "BKBRANCHNAME", "", "", this.id != null? this.bkBranchCode: "", "", false)+"</td>";
	html += "</tr>";
	...
	html += "<td>";
        String btnSave = "";
        if(this.id == null){
            btnSave = gui.formButton(request.getContextPath(), "button", "btnSave", "Save", "save.png", "onclick = \"batch.save('desc bankBranch');\"", "");
        }else{
            if(rtp == 0 || rtp == null){
                btnSave = gui.formButton(request.getContextPath(), "button", "btnSave", "Save", "save.png", "onclick = \"batch.save('desc bankBranch');\"", "");
            }
        ...
        try{
            ...
            if(this.id == null){
                ...
                query = "INSERT INTO "+this.table+" "
                        + ""
                        + "(ID, BATCHNO, BATCHDESC, DATECREATED, BKBRANCHCODE, DATEEDITED)"
                        + "VALUES"
                        + "("
                        + id+ ","
                        + id+ ","
    ...
    public Object rtp(){
        ...
        try{
            ...
            String drTotal_ = system.getOneAgt("CBDTLS", "SUM", "DRAMOUNT", "SM", "BATCHNO = "+ this.batchNo);
            drTotal_        = drTotal_ != null?drTotal_: "0";
            Double drTotal  = Double.parseDouble(drTotal_);
            String crTotal_ = system.getOneAgt("CBDTLS", "SUM", "CRAMOUNT", "SM", "BATCHNO = "+ this.batchNo);  
            crTotal_        = crTotal_ != null?crTotal_: "0";
            Double crTotal  = Double.parseDouble(crTotal_);
    ...
    public Object post(){
        ...
        try{
            ...
            String batchPosted = cB.postCbBatch(this.batchNo, session, request);
