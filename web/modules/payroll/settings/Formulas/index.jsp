            ...
            var formulas = {
                searchGLAccount: function(){
                    ...
                    if(count <= 0){
                        ...
                        new Ajax.Autocompleter(
                                ...
                                minChars   : 2,
                                frequency  : 1.0,
                                afterUpdateElement : formulas.setAccount
                            });
                    }
                },
                setAccount: function(text, glAccount){
                    if(glAccount.id !== ''){
                        ...
                        formulas.getGLAccount(glAccount.id);
                    }
                },
                    ...
                    new Ajax.Request(module.ajaxUrl, {
                        ...
                        onSuccess: function(request) {
                            ...
                            if(typeof response.success === 'number' && response.success === 1){
                                ...
                                if(typeof response.accountName !== 'undefined' && $('spAccountName')) $('spAccountName').update(response.accountName);
