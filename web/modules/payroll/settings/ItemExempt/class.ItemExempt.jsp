...
final class ItemExempt{
    String table        = "PYITEMEXM";
    String view         = "VIEWPYITEMEXM";
...
//                    + session.getAttribute("maxRecord");
            ...
            try{
                ...
                html += "<th>Name </th>";
                html += "<th>Grade</th>";
                html += "<th>Staff Category</th>";
                html += "<th>Engagement Term</th>";
                html += "<th>Options</th>";
                html += "</tr>";
    ...
    public String getModule(){
        ...
        html += "<tr>";
	html += "<td width = \"15%\" nowrap>"+gui.formIcon(request.getContextPath(),"page-edit.png", "", "")+" "+gui.formLabel("item", "Transaction")+"</td>";
	html += "<td>"+ gui.formAutoComplete("item", 13, this.id != null? ""+ this.itemCode: "", "itemsExempt.searchItem", "itemCode", this.id != null? ""+ this.itemCode: "")+ " <span id = \"spItemName\">"+ itemName+ "</span></td>";
	html += "</tr>";
        
        html += "<tr>";
	html += "<td nowrap>"+gui.formIcon(request.getContextPath(),"page-white-edit.png", "", "")+" "+gui.formLabel("grade", "Grade")+"</td>";
        html += "<td>"+ gui.formSelect("grade", "HRGRADES", "GRADECODE", "GRADENAME", "", "", this.id != null? this.gradeCode: "", "onchange = \"\"", false)+ "</td>";
	html += "</tr>";
        
        html += "<tr>";
	html += "<td nowrap>"+gui.formIcon(request.getContextPath(),"page-edit.png", "", "")+" "+gui.formLabel("category", "Staff Category")+"</td>";
        html += "<td>"+ gui.formSelect("category", "HRCATEGORY", "CATEGORYCODE", "CATEGORYNAME", "", "", this.id != null? this.categoryCode: "", "onchange = \"\"", false)+ "</td>";
	html += "</tr>";
        
        html += "<tr>";
	html += "<td nowrap>"+gui.formIcon(request.getContextPath(),"page-white-edit.png", "", "")+" "+gui.formLabel("engTerms", "Engagement Terms")+"</td>";
        html += "<td>"+ gui.formSelect("engTerms", "HRENGTERMS", "ENGTRMCODE", "ENGTRMNAME", "", "", this.id != null? this.engTrmCode: "", "onchange = \"\"", false)+ "</td>";
	html += "</tr>";
        
        html += "<tr>";
	html += "<td>&nbsp;</td>";
	html += "<td>";
	html += gui.formButton(request.getContextPath(), "button", "btnSave", "Save", "save.png", "onclick = \"itemsExempt.save('item grade category engTerms');\"", "");
        if(this.id != null){
            html += gui.formButton(request.getContextPath(), "button", "btnDelete", "Delete", "delete.png", "onclick = \"itemsExempt.purge("+this.id+",'"+this.itemCode+"');\"", "");
        }
        ...
        try{
            ...
            if(this.id == null){
                ...
                query = "INSERT INTO "+this.table+" "
                    + "(ID, ITEMCODE, GRADECODE, CATEGORYCODE, ENGTRMCODE)"
                    + "VALUES"
                    + "("
                    + id+","
                    + "'"+this.itemCode+"', "
