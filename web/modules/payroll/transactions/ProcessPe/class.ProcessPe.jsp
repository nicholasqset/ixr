...
<%
    ...
    final class ProcessPe {
        ...
        public String getProcessTab() {
            ...
            html += "<td>" + gui.formSelect("pYear", this.comCode+".FNFISCALPRD", "PYEAR", "", "PYEAR DESC", "PYEAR = "+ sys.getPeriodYear(session.getAttribute("comCode").toString()), ""+ sys.getPeriodYear(session.getAttribute("comCode").toString())
            , "", false)+ "</td>";
            html += "<td>" + gui.formSelect("nextPyear", this.comCode+".FNFISCALPRD", "PYEAR", "", "PYEAR DESC", "PYEAR = " + sys.getNextPeriodYear(session.getAttribute("comCode").toString()), "" + sys.getNextPeriodYear(session.getAttribute("comCode").toString()), "", false) + "</td>";
            html += "</tr>";
