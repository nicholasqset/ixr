            ...
            var staffExempt = {
                    ...
                    if(count <= 0){
                        ...
                        new Ajax.Autocompleter(
                                'staff', getResultTo, module.ajaxUrl, {
                                    ...
                                    minChars   : 2,
                                    frequency  : 1.0,
                                    afterUpdateElement : staffExempt.setStaff
                                }
                            );
                    }
                },
                setStaff: function(text, staff){
                    if(staff.id !== ''){
                        ...
                        staffExempt.getStaffDtls(staff.id);
                    }
                },
                    ...
                    if(count <= 0){
                        ...
                        new Ajax.Autocompleter(
                                'item', getResultTo, module.ajaxUrl, {
                                    ...
                                    minChars   : 2,
                                    frequency  : 1.0,
                                    afterUpdateElement : staffExempt.setItem
                                }
                            );
                    }
                },
                setItem: function(text, item){
                    if(item.id !== ''){
                        ...
                        staffExempt.getItemDtls(item.id);
                    }
                },
                    ...
                    new Ajax.Request(module.ajaxUrl, {
                        ...
                        onSuccess: function(request) {
                            ...
                            if(typeof response.success === 'number' && response.success === 1){
                                ...
                                if(typeof response.itemName !== 'undefined' && $('spItemName')) $('spItemName').update(response.itemName);
