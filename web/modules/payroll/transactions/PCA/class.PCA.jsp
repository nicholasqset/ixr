...
final class PCA{
    ...
    String table            = session.getAttribute("comCode")+".PYPCAHDR";
    String view             = session.getAttribute("comCode")+".VIEWPYPCAHDR";
...
//        String defaultDate = sys.getLogDate();
        String defaultDate = sys.getPeriodYear()+ "-"+ sys.getPeriodMonth()+ "-01";
	...
	html += "<td width = \"17%\" nowrap>"+ gui.formIcon(request.getContextPath(), "calendar.png", "", "")+ gui.formLabel("pYear", " Fiscal Year")+ "</td>";
        html += "<td width = \"33%\">"+ gui.formSelect("pYear", "FNFISCALPRD", "PYEAR", "", "PYEAR DESC", "", this.id != null? ""+ this.pYear: ""+sys.getPeriodYear(), "", false)+"</td>";
    ...
    public Object getOldAmount(){
        ...
        String sqlWhere = "PFNO = '"+ this.pfNo+ "' AND ITEMCODE = '"+ this.itemCode+ "' AND PYEAR = '"+ sys.getPrevPeriodYear()+ "' AND PMONTH = '"+ sys.getPrevPeriodMonth()+ "'";
