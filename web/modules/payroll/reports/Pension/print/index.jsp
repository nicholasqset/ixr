...
//        query = ""
//                    (
//                            get_py_slip_amount(pfno, '435', "+ pYear+ ", "+ pMonth+ ")
//                            +
//                            get_py_slip_amount(pfno, '440', "+ pYear+ ", "+ pMonth+ ")
//                            +
//                            get_py_slip_amount(pfno, '445', "+ pYear+ ", "+ pMonth+ ")
//                    ) > 0
        ...
        query = ""
                ...
                +  pYear+ " pyear, "
                +  pMonth+ " pmonth, "
                + comCode+ ".get_py_slip_amount(pfno, '435', "+ pYear+ ", "+ pMonth+ ") pension_employee, "
                + comCode+ ".get_py_slip_amount(pfno, '440', "+ pYear+ ", "+ pMonth+ ") pension_employer, "
                + comCode+ ".get_py_slip_amount(pfno, '445', "+ pYear+ ", "+ pMonth+ ") voluntary_pension, "
                + "( "
                + comCode+ ".get_py_slip_amount(pfno, '435', "+ pYear+ ", "+ pMonth+ ") "
                + "+ "
                + comCode+ ".get_py_slip_amount(pfno, '440', "+ pYear+ ", "+ pMonth+ ") "
                + "+ "
                + comCode+ ".get_py_slip_amount(pfno, '445', "+ pYear+ ", "+ pMonth+ ") "
                + ") pension_total "
                + "FROM "
