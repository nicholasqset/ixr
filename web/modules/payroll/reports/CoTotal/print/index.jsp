...
//        query = " SELECT * FROM VIEWBANKREMITTANCE WHERE PYEAR = "+ pYear+ " AND PMONTH = '"+ pMonth+ "' ";
        
//        SELECT 
//                itemcode, itemname, pyear, pmonth, hdrtype, hdrname, hdrpos, itempos,
//                SUM(amount) amount,
//                (SELECT COUNT(DISTINCT pfno) FROM viewpyslip WHERE pyear = "+ pYear+ " AND pmonth = "+ pMonth+ ") CNT_STAFFS
//        FROM
//                viewpyslip
//        WHERE
//                pyear = "+ pYear+ " AND
...
//        ";
        query = ""
                ...
                + "itemcode, itemname, pyear, pmonth, hdrtype, hdrname, hdrpos, itempos, "
                + "SUM(amount) amount, "
                + "(SELECT COUNT(DISTINCT pfno) FROM "+ comCode+".viewpyslip WHERE pyear = "+ pYear+ " AND pmonth = "+ pMonth+ ") CNT_STAFFS "
                + "FROM "
                + comCode+ ".viewpyslip "
                + "WHERE "
                + "pyear = "+ pYear+ " AND "
