...
<%
    ...
    try{
        ...
        String itemCode  = (request.getParameter("item") != null && ! request.getParameter("item").trim().equals(""))? request.getParameter("item"): null;
        
//        String outputForm = "html";
        String outputForm = "excel";
        
        String rptName = "PerItemListing";
        
//        out.print("itemCode = "+ itemCode);
//        
        ...
        if(itemCode != null){
            query = " SELECT * FROM "+ comCode+ ".VIEWPYSLIP WHERE ITEMCODE = '"+ itemCode+"' AND PYEAR = "+ pYear+ " AND PMONTH = '"+ pMonth+ "' ";
        }else{
            query = " SELECT * FROM "+ comCode+ ".VIEWPYSLIP WHERE PYEAR = "+ pYear+ " AND PMONTH = '"+ pMonth+ "' ";
        }
