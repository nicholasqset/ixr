...
//        ";
        query = ""
                + "SELECT "
                + "s.*, "
                + "(SELECT amount FROM "+comCode +".pyslip WHERE pfno = s.pfno AND itemcode = '410' AND pyear = "+ pYear+ " AND pmonth  = "+ pMonth+ ")nhif, "
                + "'410' itemcode, "
                ...
                + "WHERE "
                + "active = 1 AND "
                + "pfno NOT IN (SELECT pfno FROM "+comCode+".pystaffexempt WHERE itemcode = '410')"
                + "";
