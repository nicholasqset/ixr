                ...
                print: function(required){
                    if(module.validate(required)){
                        ...
                        var printWindow = window.open(
                                './print?'+ data, '', 'height=560, width=1120, toolbar=no, menubar=no, directories=no, location=no, scrollbars=yes, status=no, resizable=no, fullscreen=no, top=128, left=128');
                        printWindow.focus();
                    }
                }
            };
