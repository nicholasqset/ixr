...
//        if(itemCode != null){
//            query = " SELECT * FROM VIEWPYSLIP WHERE ITEMCODE = '"+ itemCode+"' AND PYEAR = "+ pYear+ " AND PMONTH = '"+ pMonth+ "' ";
//        }else{
            
        query = " SELECT * FROM "+comCode+".VIEWBANKREMITTANCE WHERE PYEAR = "+ pYear+ " AND PMONTH = '"+ pMonth+ "' ";
//        }
