...
final class Category{
    ...
    String table        = comCode+".re_cats";
    String view         = comCode+".re_cats";
    ...
    public String getGrid(){
        ...
        if(recordCount > 0){
            ...
            gridSql = "SELECT A.*, B.CATNAME FROM "+ this.view+ " A "
            + "LEFT JOIN "+this.comCode+".icitemcats B ON B.CATCODE = A.cat_code "
            + ""+ filterSql+ " ORDER BY "+ orderBy+ limitSql;
...
//        String islab = "";
        ...
        if(this.id != null){
            try{
                Connection conn = ConnectionProvider.getConnection();
                Statement stmt = conn.createStatement();
                String query = "SELECT A.*, B.CATNAME FROM "+ this.view+ " A "
                + "LEFT JOIN "+ this.comCode+ ".ICITEMCATS B ON B.CATCODE = A.cat_code "
                + "WHERE A.ID = "+ this.id;
