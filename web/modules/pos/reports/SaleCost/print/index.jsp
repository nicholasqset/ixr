...
//        query   = " SELECT * FROM VIEWPSPYDTLS WHERE ENTRYDATE = '"+ entryDate1+ "' ";
        query   = " SELECT *, (UNITCOST * QTY) TOTALCOST, AMOUNT - (UNITCOST * QTY) DIFF FROM "+comCode+".VIEWPSPYDTLS WHERE ENTRYDATE::DATE BETWEEN '"+ entryDate1+ "' AND '"+ entryDate2+ "'  AND CHANGE >= 0";
        out.print(query);
