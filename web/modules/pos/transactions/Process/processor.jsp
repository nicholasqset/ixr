 ...
 final class Process{
    ...
    public Integer getReceiptCount(){
        ...
        try{
            ...
            query = "SELECT COUNT(PYNO)DCT FROM PSPYHDR WHERE PYEAR = "+ this.pYear+ " AND PMONTH = "+ this.pMonth+ " AND CLEARED = 1 AND (POSTED IS NULL OR POSTED = 0)";
    ...
    public String markPosted(String pyNo){
        ...
        try{
            ...
            stmt.executeUpdate("UPDATE PSPYHDR SET POSTED = 1 WHERE PYNO = '"+ pyNo+ "'");
...
try{
    ...
    if(recordCount > 0){
        ...
        String query = "SELECT PYNO FROM PSPYHDR WHERE PYEAR = "+ process.pYear+ " AND PMONTH = "+ process.pMonth+ " AND CLEARED = 1 AND (POSTED IS NULL OR POSTED = 0)";
        ...
        while(rs.next()){
            ...
            String pyPosted = pos.postReceipt(pyNo, session, request);
