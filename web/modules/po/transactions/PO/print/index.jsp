<%@page import="com.qset.po.PoPoHdr"%>
...
<%
    final class PrintRptPo{
        HttpSession session     = request.getSession();
        String comCode          = session.getAttribute("comCode").toString();
        String poNo         = request.getParameter("poNo") != null && ! request.getParameter("poNo").trim().equals("")? request.getParameter("poNo"): null;
    
        String rptName  = "Purchase Order";
...
//                String comCode = sys.getOne("CSCOPROFILE", "COMPANYCODE", "");
        ...
        public String getReportDetails(){
            ...
            PoPoHdr poPoHdr = new PoPoHdr(poNo, comCode);
            ...
            try{
                ...
                java.util.Date entryDate = originalFormat.parse(poPoHdr.entryDate);
            ...
            html += "<td>"+ this.poNo +"</td>";
            html += "</tr>";

            html += "<tr>";
            html += "<td class = \"bold\">Description</td>";
            html += "<td>"+ poPoHdr.poDesc+ "</td>";
            html += "</tr>";
            ...
            html += "<td>"+ poPoHdr.pYear+ " - "+ poPoHdr.pMonth+ "</td>";
            html += "</tr>";

            html += "<tr>";
            html += "<td class = \"bold\">Supplier</td>";
            html += "<td>"+ poPoHdr.supplierNo+ "</td>";
            html += "</tr>";
            ...
            if(sys.recordExists(comCode+".VIEWPOPODTLS", "PONO = '"+ this.poNo+ "'")){
               ...
               html += "<tr>";
                ...
                try{
                    ...
                    query = "SELECT * FROM "+comCode+".VIEWPOPODTLS WHERE PONO = '"+ this.poNo+ "' ORDER BY ITEMCODE";
    ...
    PrintRptPo printRptPo = new PrintRptPo();
